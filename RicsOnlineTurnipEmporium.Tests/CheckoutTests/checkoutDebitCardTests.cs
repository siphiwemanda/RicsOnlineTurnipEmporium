...
namespace RicsOnlineTurnipEmporium.Tests.CheckoutTests
{
    ...
    public class CheckoutDebitCardTests
    {
        ...
        [Test]
        public void DebitCardThrowsErrorForIncorectPaymentType()
        {
            var checkout = new Checkout();
     
            Assert.That(() => checkout.MakePayment(PaymentType.BitCoin, 500, new DirectDebitAccountDetails("Manda", "7777","444")), Throws.Exception);
