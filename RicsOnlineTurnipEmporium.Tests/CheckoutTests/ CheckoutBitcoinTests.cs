...
namespace RicsOnlineTurnipEmporium.Tests.CheckoutTests
{
    ...
    {
        [Test]
        public void ReturnSuccessfulResultForPaymentForBitcoin()
        {
            var checkout = new Checkout();
            var payment = checkout.MakePayment(PaymentType.BitCoin, 0,  new BitCoinAccountDetails("93098DDA-3873-484A-B4A4-19C25438A71A", "31ACD47B-60D5-4FA5-9213-D7A02C55E172", "78736511-480E-4A3C-8F07-CE4BED6E0387"));
